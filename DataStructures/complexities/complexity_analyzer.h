...
namespace ds::utils
{
    ...
    protected:
        ...
        virtual void beforeReplication(Structure& structure) {};
    ...
    void ComplexityAnalyzer<Structure>::analyze(Structure structurePrototype)
    {
        ...
        {
            Structure st(structurePrototype); // vytvorili sme kopiu struktury, danou parametrom
            this->beforeReplication(st);
